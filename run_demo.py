...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="homie_rl.pt", help="Path to checkpoint")
    parser.add_argument("--viewer", type=str, default="auto", choices=["auto", "native", "viser"], help="Viewer type")
    parser.add_argument("--num-envs", type=int, default=1, help="Number of environments")
    args = parser.parse_args()
    
    run_demo(checkpoint_path=args.checkpoint, viewer_type=args.viewer, num_envs=args.num_envs)
